...
<header>
    ...
    if(Admin::findOne(['user_id' => Yii::$app->user->id])){
        $menuItems[] = ['label' => 'Программы', 'url' => ['program/index']];
        $menuItems[] = ['label' => 'Предметы', 'url' => ['subject/index']];
        $menuItems[] = ['label' => 'Виды', 'url' => ['file-type/index']];
        $menuItems[] = ['label' => 'Работы', 'url' => ['work/index']];
        $menuItems[] = ['label' => 'Корзина', 'url' => ['bin/index']];
    }
